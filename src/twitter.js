...
const getReplies = async (conversationId) => {
	const request = {
		url: `https://api.twitter.com/2/tweets/search/recent?tweet.fields=author_id&query=conversation_id:${conversationId}`,
		method: 'GET',
		body: {
			"uniqueId": 1234
		}
...
const main = async () => {
	...
	console.log(await getReplies(1581804042036002816))
}
